...
export default function WordGeneratorPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 animate-fade-up">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-[24px] sm:text-[28px] md:text-[36px] font-extrabold flex items-center gap-2 sm:gap-3" style={{ color: "var(--text-heading)" }}>
          <Icon name="sparkle" size={28} color="var(--accent-orange)" /> Word Generator
        </h1>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <h2 className="text-lg sm:text-xl font-bold truncate" style={{ color: "var(--text-heading)" }}>{w.word}</h2>
                    {w.phonetic && <span className="text-sm shrink-0 hidden sm:inline" style={{ color: "var(--text-body-subtle)" }}><Phonetic word={w.word} fallback={w.phonetic} /></span>}
                  </div>
