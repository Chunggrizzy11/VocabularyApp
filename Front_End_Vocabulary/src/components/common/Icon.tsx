...
const paths: Record<IconName, string> = {
  ...
  "clock":
    "M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm1-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z",
  "dots":
    "M12 5h.01M12 12h.01M12 19h.01",
};
