...
exports.topicController = {
    getAll: async (_req, res) => {
        try {
            ...
            return (0, response_1.success)(res, topics);
        }
        catch (e) {
    ...
    getById: async (req, res) => {
        try {
            ...
            if (!topic)
                return (0, response_1.error)(res, "Topic not found", 404);
            return (0, response_1.success)(res, topic);
        }
        catch (e) {
            return (0, response_1.error)(res, e.message);
        }
    ...
    create: async (req, res) => {
        try {
            ...
            return (0, response_1.created)(res, topic);
        }
        catch (e) {
            return (0, response_1.error)(res, e.message);
        }
